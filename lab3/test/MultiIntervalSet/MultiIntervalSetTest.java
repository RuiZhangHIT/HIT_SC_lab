...
public class MultiIntervalSetTest {
	...
	//
	// MultiIntervalSet():
	//     no inputs, with an input IntervalSet initial
	// insert():
	...
	// labels():
	//     the MultiIntervalSet is empty, not empty
	// remove():
    ...
    //Cover: the MultiIntervalSet is empty
    @Test
    public void testMultiIntervalSetEmpty(){
    	MultiIntervalSet<String> intervals = new MultiIntervalSet<>();
        assertEquals(Collections.emptySet(),intervals.labels());
    }
    
    //Cover: the MultiIntervalSet is not empty
    @Test
    public void testMultiIntervalSetNotEmpty(){
    	IntervalSet<String> initial = IntervalSet.empty();
    	initial.insert(2, 6, "Java");
    	MultiIntervalSet<String> intervals = new MultiIntervalSet<>(initial);
